...
async function processTCFile(
  ...
  if (!extracted.arrivalDate || !extracted.departureDate) {
    ...
    await prisma.booking.update({
      ...
      data: {
        ...
        ...(extracted.cntlNumber    && { cntlNumber:    extracted.cntlNumber as string }),
  ...
  const commonData = {
    ...
    cntlNumber:         (extracted.cntlNumber as string | null) ?? undefined,
    ...
    valueAddedServices: (extracted.valueAddedServices as string | null) ?? undefined,
    packageIncludes:    (extracted.packageIncludes   as string | null) ?? undefined,
    packageExcludes:    (extracted.packageExcludes   as string | null) ?? undefined,
    importantNotes:     (extracted.importantNotes    as string | null) ?? undefined,
    tips:               (extracted.tips              as string | null) ?? undefined,
    otherNote:          (extracted.otherNote         as string | null) ?? undefined,
    clientRequest:      (extracted.clientRequest     as string | null) ?? undefined,
