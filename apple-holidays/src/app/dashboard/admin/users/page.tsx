          ...
          <div className="p-3 rounded-lg bg-blue-50 border border-blue-100 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-blue-600 mt-0.5">
                ...
                {form.role === 'GT_VN_USER'  && 'Vietnam ground team, limited: Vietnam dashboard, bookings list, booking details (agenda, tickets, drivers, PDF), the Detailed P&L costing sheet, the MC Report and the Ops Board. Runs the pipeline from driver allocation through QC1, tickets and QC2 to the D-3 customer message, and may send the portal link, the booking WhatsApp messages and the daily trip details, and correct contact numbers and meal preferences. Nothing else. (Vietnam only)'}
