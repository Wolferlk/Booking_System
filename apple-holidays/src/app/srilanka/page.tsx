...
const ROLES = [
  {
    ...
    label: 'Booking Team',
    sublabel: 'BT_USER',
    email: 'sl-bt@apple.com',
    description: 'Create and manage Sri Lanka travel bookings, handle change requests and passenger details.',
    icon: FileText,
  ...
  {
    id: 'SUPER_ADMIN',
    label: 'Sri Lanka Admin',
    sublabel: 'SUPER_ADMIN',
    email: 'sl-admin@apple.com',
    description: 'Full access to Sri Lanka operations — all modules, user management and audit log.',
    icon: Shield,
    gradient: 'from-yellow-600/20 to-red-800/10',
  ...
  return (
    <div className="min-h-screen bg-[#060a14]">
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-50px] right-0 w-[700px] h-[500px] bg-yellow-600/5 rounded-full blur-[120px]" />
        <div className="absolute bottom-0 left-0 w-[600px] h-[500px] bg-red-800/5 rounded-full blur-[100px]" />
        <div
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-8 py-14">
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-4 mb-5">
            <CountryFlag country="SRILANKA" className="w-16 h-auto rounded-sm drop-shadow-lg" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 max-w-4xl mx-auto">
          {ROLES.map(role => {
            ...
            return (
              <button
                key={role.id}
                onClick={() => router.push(`/login?country=srilanka&role=${role.id}`)}
                className={`
