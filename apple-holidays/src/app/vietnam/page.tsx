      ...
      <header className="relative z-10 border-b border-white/5 bg-[#060a14]/80 backdrop-blur-sm sticky top-0">
        <div className="max-w-7xl mx-auto px-8 py-4 flex items-center gap-5">
          ...
          <div className="ml-auto">
            <Link
              href="/vietnam/users"
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 text-slate-300 hover:text-white transition-all text-sm font-medium"
            >
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-8 py-14">
        ...
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-4 mb-5">
            <CountryFlag country="VIETNAM" className="text-[30px] leading-none drop-shadow-lg" />
